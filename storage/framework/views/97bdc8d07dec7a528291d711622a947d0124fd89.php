                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <?php  $i=1;?>
                                 <?php $__currentLoopData = $conf; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $confs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                    <tr class="odd gradeX">
                                        <td><?php echo $i++;?></td>
                                        <td><?php echo e($confs->admin_id); ?></td>
                                        <td><?php echo e($confs->site_name); ?></td>
                                        <td><?php echo e($confs->admin_amount); ?></td>
                                        <td class="center"><?php echo e($confs->amc_amount); ?> </td>

                                        <td class="center"><a  class="btn btn-primary fa fa-pencil" href="<?php echo e(url('/configuration/edit')); ?>/<?php echo e($confs->id); ?>"></a>
                                        &nbsp;&nbsp;
                                        <a class="fa fa-trash  btn btn-danger" href="<?php echo e(url('/configuration/del')); ?>/<?php echo e($confs->id); ?>"></a></td>
                                    </tr>
