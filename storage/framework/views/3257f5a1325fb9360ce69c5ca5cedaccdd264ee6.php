                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                       ...
                                       <td><?= $voucher->voucher_code;?></td>
                                        ...
                                        <td><a  class="fa fa-pencil btn btn-primary" href="<?php echo e(url('/voucher/edit')); ?>/<?= $voucher->id;?>"></a>&nbsp;&nbsp;&nbsp;<a class="fa fa-trash btn btn-danger" href="<?php echo e(url('voucher/delete/')); ?>/<?= $voucher->id;?>" onclick="return confirm('Are you sure you want to delete this item?');"></a></td>
                                    </tr>
                                    <?php }?>
                                </tbody>
