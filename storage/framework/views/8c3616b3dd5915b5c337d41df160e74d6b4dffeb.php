                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <a href="<?php echo e(url('/payment/add')); ?>" type="button" class="btn btn-primary btn-md">Add Payment </a>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                       ...
                                       <td></td>
                                        ...
                                        <td><a  class="fa fa-pencil btn btn-primary" href="<?php echo e(url('/payment/edit')); ?>/<?= $payment->id;?>"></a>&nbsp;&nbsp;&nbsp;
                                        <a class="fa fa-trash btn btn-danger" href="<?php echo e(url('/payment/del')); ?>/<?= $payment->id;?>"></a></td>
                                    </tr>
                                    <?php }?>
                                </tbody>
